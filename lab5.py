...
def main():
    account_John_Doe = BankAccount(1, "John Doe", 1000.0)
    account_Jane_Doe = BankAccount(2, "Jane Doe", 2000.0)
    account_Bob_Smith = BankAccount(3, "Bob Smith", 1500.0)
    ...
    print("Accounts before sorting:")
    bank.show_all_accounts()
    accounts_John_Doe.deposite(500.0)
    account_Jane_Doe.withdraw(1000.0)
